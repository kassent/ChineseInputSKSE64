...
static void* GetIATAddr(void* module, const char* searchDllName, const char* searchImportName)
{
...
public:
	...
	static HRESULT D3D11CreateDeviceAndSwapChain_Hook(IDXGIAdapter* pAdapter, D3D_DRIVER_TYPE DriverType, HMODULE Software, UINT Flags, CONST D3D_FEATURE_LEVEL* pFeatureLevels, UINT FeatureLevels, UINT SDKVersion, CONST DXGI_SWAP_CHAIN_DESC* pSwapChainDesc, IDXGISwapChain** ppSwapChain, ID3D11Device** ppDevice, D3D_FEATURE_LEVEL* pFeatureLevel, ID3D11DeviceContext** ppContext)
	{
		...
		pDevice = *ppDevice;
		pContext = *ppContext;
		if (pSwapChain && !Present_RealFunc)
		{
			REL::Offset<uintptr_t> vtbl(*(uintptr_t*)pSwapChain);
			Present_RealFunc = unrestricted_cast<FnPresent>(vtbl.WriteVFunc(8, Present_Hook));
		}
		//if (!Present_RealFunc)
		//{
	...
	static void InitHook()
	{
		...
		SKSE::SafeWrite64(thunkAddress, (uintptr_t)D3D11CreateDeviceAndSwapChain_Hook);
